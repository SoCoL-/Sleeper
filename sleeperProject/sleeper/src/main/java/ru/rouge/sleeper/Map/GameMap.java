...
public final class GameMap
{
    ...
    public static final int MINLEVELWIDTH = 25;    //Минимальная ширина уровня
    public static final int MAXLEVELWIDTH = 35;    //Максимальная ширина уровня
    public static final int MINLEVELHEIGHT = 20;   //Максимальная высота уровня
    public static final int MAXLEVELHEIGHT = 40;   //Максимальная высота уровня
